      ...
      <div className="w-full container max-w-[1440px] mx-auto">
        <div className="w-full flex flex-col justify-center items-center gap-5">
          <div className="flex flex-col justify-center items-center gap-[64px]">
            <p className="body-font font-Poppins text-[32px] font-[700]">
              We have what you’re looking for
            </p>
            <p className="text-blue-500 text-[12px] font-[400] w-[596px] text-center font-Poppins body-font">
          ...
          <div className='pt-[2rem]'>
            <button className=" text-[20px] font-[700] w-[237px] h-[60px] text-white rounded-md bg-linear-grad">
              Get Started Now
            </button>
          </div>
          {/* Sub Footer */}
          <div className="mt-[91px] py-2 text-white w-[80%] mx-auto border-t-2 flex justify-between items-center">
            ...
            <div className="flex gap-10 items-center">
              <div className="flex gap-3 text-[12px] font-Poppins items-center">
